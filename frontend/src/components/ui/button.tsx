...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-neon-orange",
        ...
        glow: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-neon-orange hover:shadow-[0_0_30px_rgba(255,107,53,0.6)] transition-shadow",
        neon: "bg-transparent border border-neon-purple text-neon-purple hover:bg-neon-purple/10 shadow-neon hover:shadow-[0_0_30px_rgba(168,85,247,0.6)]",
      },
      size: {
