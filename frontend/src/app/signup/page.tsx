  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 -right-1/4 w-[500px] h-[500px] rounded-full bg-neon-purple/15 blur-[120px]" />
        <div className="absolute bottom-1/3 -left-1/4 w-[400px] h-[400px] rounded-full bg-neon-orange/15 blur-[120px]" />
      ...
      >
        <GlassCard className="p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <a href={authApi.getDiscordAuthUrl()}>
              <Button variant="outline" className="w-full">
